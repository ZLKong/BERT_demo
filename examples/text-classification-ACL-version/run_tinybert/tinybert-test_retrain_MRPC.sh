...
CUDA_VISIBLE_DEVICES=6 python run_glue.py \
  --model_name_or_path /data/ZLKong/tinybert/prune/MRPC \
  --task_name $TASK_NAME \
  --do_train \
  --masked_retrain \
  --lr_retrain 4e-5 \
  ...
  --block_row_division 128 \
  --block_row_width 8 \
  --output_dir /data/ZLKong/tinybert/retrain/MRPC_50 \
  --overwrite_output_dir \
  --logging_steps 500 \
  --logging_dir /data/ZLKong/tinybert/retrain/MRPC_40 \
  --save_steps 4000
