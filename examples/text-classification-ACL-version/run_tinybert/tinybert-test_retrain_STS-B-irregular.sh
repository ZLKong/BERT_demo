...
CUDA_VISIBLE_DEVICES=1 python run_glue.py \
  --model_name_or_path /data/ZLKong/tinybert/prune-irregular/STS-B \
  --task_name $TASK_NAME \
  --do_train \
  --masked_retrain \
  --lr_retrain 2e-5 \
  ...
  --output_dir /data/ZLKong/tinybert/retrain-irregular/STS-B \
  --overwrite_output_dir \
  --logging_steps 500 \
  --logging_dir /data/ZLKong/tinybert/retrain-irregular/STS-B \
  --save_steps 4000
