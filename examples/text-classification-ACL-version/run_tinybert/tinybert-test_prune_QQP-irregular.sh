...
CUDA_VISIBLE_DEVICES=1 python run_glue.py \
  --model_name_or_path /data/ZLKong/tinybert/finetune/QQP \
  --task_name $TASK_NAME \
  --do_train \
  --rew \
  ...
  --output_dir /data/ZLKong/tinybert/prune-irregular/QQP \
  --overwrite_output_dir \
  --logging_steps 10000 \
  --logging_dir /data/ZLKong/tinybert/prune-irregular/QQP \
  --save_steps 50000
