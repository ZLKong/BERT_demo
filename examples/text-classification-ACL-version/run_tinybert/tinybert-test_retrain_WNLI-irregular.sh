...
export PRUNE_RATIO=tinybert_prune_ratios_40
...
CUDA_VISIBLE_DEVICES=1 python run_glue.py \
  --model_name_or_path /data/ZLKong/tinybert/prune-irregular/WNLI \
  --task_name $TASK_NAME \
  --do_train \
  --masked_retrain \
  --lr_retrain 3e-5 \
  ...
  --output_dir /data/ZLKong/tinybert/retrain-irregular/WNLI \
  --overwrite_output_dir \
  --logging_steps 100 \
  --logging_dir /data/ZLKong/tinybert/retrain-irregular/WNLI \
  --save_steps 4000
