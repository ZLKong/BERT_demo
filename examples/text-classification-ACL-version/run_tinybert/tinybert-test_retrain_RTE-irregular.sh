...
CUDA_VISIBLE_DEVICES=1 python run_glue.py \
  --model_name_or_path /data/ZLKong/tinybert/prune-irregular/RTE \
  --task_name $TASK_NAME \
  --do_train \
  --masked_retrain \
  --lr_retrain 4e-5 \
  ...
  --output_dir /data/ZLKong/tinybert/retrain-irregular/RTE \
  --overwrite_output_dir \
  --logging_steps 500 \
  --logging_dir /data/ZLKong/tinybert/retrain-irregular/RTE \
  --save_steps 4000
