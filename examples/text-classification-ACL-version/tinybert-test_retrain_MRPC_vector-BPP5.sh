...
export IN_DIR=/data/ZLKong/MRPC/block_size_12_1/model/prune_ratio_10
...
CUDA_VISIBLE_DEVICES=6 python run_glue.py \
  ...
  --block_row_width 12 \
  --output_dir /data/ZLKong/bert_vector/tinybert-retrain/MRPC-BPP-92 \
  --overwrite_output_dir \
  --logging_steps 20000 \
  --logging_dir /data/ZLKong/bert_vector/tinybert-retrain/MRPC-BPP-92 \
  --save_steps 40000
