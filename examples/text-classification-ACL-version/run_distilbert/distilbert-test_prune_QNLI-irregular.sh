...
CUDA_VISIBLE_DEVICES=6 python run_glue.py \
  --model_name_or_path /data/ZLKong/irregular/results/distilbert-finetune/QNLI \
  --task_name $TASK_NAME \
  --do_train \
  --rew \
  ...
  --output_dir /data/ZLKong/irregular/results/distilbert-prune/QNLI2 \
  --overwrite_output_dir \
  --logging_steps 4000 \
  --logging_dir /data/ZLKong/irregular/results/distilbert-prune/QNLI2 \
  --save_steps 20000
