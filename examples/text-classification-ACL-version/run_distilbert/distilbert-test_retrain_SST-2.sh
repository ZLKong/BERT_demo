...
export PRUNE_RATIO=distilbert_prune_ratios_55
...
CUDA_VISIBLE_DEVICES=5 python run_glue.py \
  ...
  --output_dir /data/ZLKong/irregular/results/distilbert-retrain/SST-2_55 \
  --overwrite_output_dir \
  --logging_steps 3000 \
  --logging_dir /data/ZLKong/irregular/results/distilbert-retrain/SST-2_55 \
  --save_steps 20000
