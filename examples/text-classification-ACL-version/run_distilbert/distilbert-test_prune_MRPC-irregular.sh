...
CUDA_VISIBLE_DEVICES=2 python run_glue.py \
  --model_name_or_path /data/ZLKong/irregular/results/distilbert-finetune/MRPC \
  --task_name $TASK_NAME \
  --do_train \
  --rew \
  ...
  --output_dir /data/ZLKong/irregular/results/distilbert-prune/MRPC \
  --overwrite_output_dir \
  --logging_steps 100 \
  --logging_dir /data/ZLKong/irregular/results/distilbert-prune/MRPC \
  --save_steps 400
