...
CUDA_VISIBLE_DEVICES=4 python run_glue.py \
  --model_name_or_path /data/ZLKong/irregular/results/distilbert-finetune/QQP \
  --task_name $TASK_NAME \
  --do_train \
  --rew \
  ...
  --output_dir /data/ZLKong/irregular/results/distilbert-prune/QQP \
  --overwrite_output_dir \
  --logging_steps 10000 \
  --logging_dir /data/ZLKong/irregular/results/distilbert-prune/QQP \
  --save_steps 40000
