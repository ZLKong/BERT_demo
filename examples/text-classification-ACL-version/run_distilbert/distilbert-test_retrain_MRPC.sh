...
export PRUNE_RATIO=distilbert_prune_ratios_40
...
CUDA_VISIBLE_DEVICES=6 python run_glue.py \
  ...
  --output_dir /data/ZLKong/irregular/results/distilbert-retrain/MRPC_50 \
  --overwrite_output_dir \
  --logging_steps 150 \
  --logging_dir /data/ZLKong/irregular/results/distilbert-retrain/MRPC_50 \
  --save_steps 4000
