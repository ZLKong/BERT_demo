...
CUDA_VISIBLE_DEVICES=4 python run_glue.py \
  --model_name_or_path /data/ZLKong/irregular/results/distilbert-finetune/SST-2 \
  --task_name $TASK_NAME \
  --do_train \
  --rew \
  ...
  --output_dir /data/ZLKong/irregular/results/distilbert-prune/SST-2_test \
  --overwrite_output_dir \
  --logging_steps 2000 \
  --logging_dir /data/ZLKong/irregular/results/distilbert-prune/SST-2_test \
  --save_steps 10000
