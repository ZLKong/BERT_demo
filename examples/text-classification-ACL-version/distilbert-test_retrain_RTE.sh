...
export PRUNE_RATIO=distilbert_prune_ratios_53
...
CUDA_VISIBLE_DEVICES=4 python run_glue.py \
  --model_name_or_path /data/ZLKong/irregular/results/distilbert-prune/RTE \
  --task_name $TASK_NAME \
  --do_train \
  --masked_retrain \
  --lr_retrain 2e-5 \
  ...
  --output_dir /data/ZLKong/irregular/results/distilbert-retrain/RTE_53 \
  --overwrite_output_dir \
  --logging_steps 100 \
  --logging_dir /data/ZLKong/irregular/results/distilbert-retrain/RTE_53 \
  --save_steps 20000
