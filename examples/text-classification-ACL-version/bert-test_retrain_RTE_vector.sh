...
export IN_DIR=/data/ZLKong/bert_vector/bert-prune/RTE
...
CUDA_VISIBLE_DEVICES=2 python run_glue.py \
  ...
  --block_row_width 256 \
  --output_dir /data/ZLKong/bert_vector/bert-retrain/RTE \
  --overwrite_output_dir \
  --logging_steps 20000 \
  --logging_dir /data/ZLKong/bert_vector/bert-retrain/RTE \
  --save_steps 40000
