...
CUDA_VISIBLE_DEVICES=4 python run_glue.py \
  --model_name_or_path /data/ZLKong/mobilebert/retrain/RTE_bert_blkfilter \
  --task_name $TASK_NAME \
  --do_train \
  --rew \
  ...
  --block_row_division 12 \
  --block_row_width 12 \
  --output_dir /data/ZLKong/mobilebert/prune/RTE_bert_blkcol \
  --overwrite_output_dir \
  --logging_steps 2000 \
  --logging_dir /data/ZLKong/mobilebert/prune/RTE_bert_blkcol \
  --save_steps 4000
