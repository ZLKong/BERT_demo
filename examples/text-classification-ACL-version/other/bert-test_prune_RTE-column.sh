...
CUDA_VISIBLE_DEVICES=2 python run_glue.py \
  --model_name_or_path /data/ZLKong/mobilebert/finetune/RTE-test \
  --task_name $TASK_NAME \
  --do_train \
  --rew \
  ...
  --block_row_width 3 \
  --output_dir /data/ZLKong/mobilebert/prune/RTE_bert_column \
  --overwrite_output_dir \
  --logging_steps 2000 \
  --logging_dir /data/ZLKong/mobilebert/prune/RTE_bert_column \
  --save_steps 4000
