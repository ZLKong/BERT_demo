...
export IN_DIR=/data/ZLKong/bert_whole_block/bert-prune/MNLI
...
CUDA_VISIBLE_DEVICES=6 python run_glue.py \
  ...
  --block_row_width 256 \
  --output_dir /data/ZLKong/bert_whole_block/bert-retrain/MNLI-40-noemb \
  --overwrite_output_dir \
  --logging_steps 20000 \
  --logging_dir /data/ZLKong/bert_whole_block/bert-retrain/MNLI-40-noemb \
  --save_steps 40000
