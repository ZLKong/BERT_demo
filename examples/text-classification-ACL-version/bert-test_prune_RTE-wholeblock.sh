...
CUDA_VISIBLE_DEVICES=2 python run_glue.py \
  --model_name_or_path /data/ZLKong/bert/finetune/RTE128-32-5e-5-7epo722 \
  --task_name $TASK_NAME \
  --do_train \
  --rew \
  ...
  --block_row_width 256 \
  --output_dir /data/ZLKong/mobilebert/prune/RTE_bert_whole_block \
  --overwrite_output_dir \
  --logging_steps 2000 \
  --logging_dir /data/ZLKong/mobilebert/prune/RTE_bert_whole_block \
  --save_steps 4000
