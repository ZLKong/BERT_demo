...
export PRUNE_RATIO=bert_prune_ratios_50-noemb
#export IN_DIR=/data/ZLKong/mobilebert/retrain/RTE_bert_blkfilter2
export IN_DIR=/data/ZLKong/bert_whole_block/bert-prune/SST-2
...
CUDA_VISIBLE_DEVICES=1 python run_glue.py \
  ...
  --block_row_width 256 \
  --output_dir /data/ZLKong/bert_whole_block/bert-retrain/SST-2-50-noemb \
  --overwrite_output_dir \
  --logging_steps 20000 \
  --logging_dir /data/ZLKong/bert_whole_block/bert-retrain/SST-2-50-noemb \
  --save_steps 40000
