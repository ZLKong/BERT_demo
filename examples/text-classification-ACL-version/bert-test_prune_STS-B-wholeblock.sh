...
CUDA_VISIBLE_DEVICES=2 python run_glue.py \
  --model_name_or_path /data/ZLKong/irregular/results/bert-finetune/STS-B \
  --task_name $TASK_NAME \
  --do_train \
  --rew \
  ...
  --block_row_width 256 \
  --output_dir /data/ZLKong/bert_whole_block/bert-prune/STS-B \
  --overwrite_output_dir \
  --logging_steps 20000 \
  --logging_dir  /data/ZLKong/bert_whole_block/bert-prune/STS-B \
  --save_steps 40000
