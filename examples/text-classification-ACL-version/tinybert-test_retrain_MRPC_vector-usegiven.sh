...
export IN_DIR=/data/ZLKong/bert_vector/tinybert-prune/MRPC-given
#export IN_DIR=/data/ZLKong/bert_vector/tinybert-retrain/MRPC-given
...
CUDA_VISIBLE_DEVICES=6 python run_glue.py \
  ...
  --block_row_width 12 \
  --output_dir /data/ZLKong/bert_vector/tinybert-retrain/MRPC-given \
  --overwrite_output_dir \
  --logging_steps 20000 \
  --logging_dir /data/ZLKong/bert_vector/tinybert-retrain/MRPC-given \
  --save_steps 40000
