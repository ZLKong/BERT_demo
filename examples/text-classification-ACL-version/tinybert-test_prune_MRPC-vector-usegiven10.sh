...
CUDA_VISIBLE_DEVICES=3 python run_glue.py \
  --model_name_or_path /data/ZLKong/TinyBERT_4L_312D/MRPC \
  --task_name $TASK_NAME \
  --do_train \
  --rew \
  ...
  --block_row_width 10 \
  --output_dir /data/ZLKong/bert_vector/tinybert-prune/MRPC-given10 \
  --overwrite_output_dir \
  --logging_steps 20000 \
  --logging_dir  /data/ZLKong/bert_vector/tinybert-prune/MRPC-given10 \
  --save_steps 40000
