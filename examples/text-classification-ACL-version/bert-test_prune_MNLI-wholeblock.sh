...
CUDA_VISIBLE_DEVICES=6 python run_glue.py \
  --model_name_or_path /data/ZLKong/irregular/results/bert-finetune/MNLI \
  --task_name $TASK_NAME \
  --do_train \
  --rew \
  ...
  --block_row_width 256 \
  --output_dir /data/ZLKong/bert_whole_block/bert-prune/MNLI \
  --overwrite_output_dir \
  --logging_steps 20000 \
  --logging_dir  /data/ZLKong/bert_whole_block/bert-prune/MNLI \
  --save_steps 40000
