...
CUDA_VISIBLE_DEVICES=6 python run_glue.py \
  --model_name_or_path /data/ZLKong/irregular/results/roberta-finetune/MRPC \
  --task_name $TASK_NAME \
  --do_train \
  --rew \
  ...
  --output_dir /data/ZLKong/irregular/results/roberta-prune/MRPC \
  --overwrite_output_dir \
  --logging_steps 100 \
  --logging_dir /data/ZLKong/irregular/results/roberta-prune/MRPC \
  --save_steps 400
