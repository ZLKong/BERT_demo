...
export PRUNE_RATIO=prune_ratios_30
...
CUDA_VISIBLE_DEVICES=3 python run_glue.py \
  --model_name_or_path /data/ZLKong/irregular/results/roberta-prune/WNLI  \
  --task_name $TASK_NAME \
  --do_train \
  --masked_retrain \
  --lr_retrain 3e-5 \
  ...
  --output_dir /data/ZLKong/irregular/results/roberta-retrain/WNLI_30 \
  --overwrite_output_dir \
  --logging_steps 2000 \
  --logging_dir /data/ZLKong/irregular/results/roberta-retrain/WNLI_30 \
  --save_steps 4000
