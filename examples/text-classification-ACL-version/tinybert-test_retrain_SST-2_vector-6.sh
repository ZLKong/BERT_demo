...
export IN_DIR=/data/ZLKong/bert_vector/tinybert-prune/SST-22
...
CUDA_VISIBLE_DEVICES=4 python run_glue.py \
  ...
  --block_row_width 12 \
  --output_dir /data/ZLKong/bert_vector/tinybert-retrain/SST-2-12-92rate-6 \
  --overwrite_output_dir \
  --logging_steps 20000 \
  --logging_dir /data/ZLKong/bert_vector/tinybert-retrain/SST-2-12-92rate-6 \
  --save_steps 40000
