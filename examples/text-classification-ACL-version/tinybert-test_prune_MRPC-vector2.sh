...
CUDA_VISIBLE_DEVICES=0 python run_glue.py \
  --model_name_or_path /data/ZLKong/tinybert/finetune/MRPC \
  --task_name $TASK_NAME \
  --do_train \
  --rew \
  ...
  --block_row_width 12 \
  --output_dir /data/ZLKong/bert_vector/tinybert-prune/MRPC2 \
  --overwrite_output_dir \
  --logging_steps 20000 \
  --logging_dir  /data/ZLKong/bert_vector/tinybert-prune/MRPC2 \
  --save_steps 40000
