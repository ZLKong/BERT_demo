...
export IN_DIR=/data/ZLKong/mobilebert/prune/RTE_bert_whole_block
...
CUDA_VISIBLE_DEVICES=0 python run_glue.py \
  ...
  --block_row_width 256 \
  --output_dir /data/ZLKong/bert_whole_block/bert-retrain/RTE-30-noemb \
  --overwrite_output_dir \
  --logging_steps 1500 \
  --logging_dir /data/ZLKong/bert_whole_block/bert-retrain/RTE-30-noemb \
  --save_steps 4000
