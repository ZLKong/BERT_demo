...
CUDA_VISIBLE_DEVICES=3 python run_glue.py \
  --model_name_or_path /data/ZLKong/irregular/results/distilbert-finetune/RTE \
  --task_name $TASK_NAME \
  --do_train \
  --rew \
  ...
  --output_dir /data/ZLKong/irregular/results/distilbert-prune/RTE_test \
  --overwrite_output_dir \
  --logging_steps 100 \
  --logging_dir /data/ZLKong/irregular/results/distilbert-prune/RTE_test \
  --save_steps 400
