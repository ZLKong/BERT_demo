...
export PRUNE_RATIO=tinybert_prune_ratios_60
...
CUDA_VISIBLE_DEVICES=3 python run_glue.py \
  ...
  --block_row_width 12 \
  --output_dir /data/ZLKong/bert_vector/tinybert-retrain/MRPC-shaoyi-60 \
  --overwrite_output_dir \
  --logging_steps 20000 \
  --logging_dir /data/ZLKong/bert_vector/tinybert-retrain/MRPC-shaoyi-60 \
  --save_steps 40000
