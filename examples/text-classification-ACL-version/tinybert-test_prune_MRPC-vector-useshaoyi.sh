...
CUDA_VISIBLE_DEVICES=2 python run_glue.py \
  --model_name_or_path /data/ZLKong/finetune-shaoyi/MRPC/ \
  --task_name $TASK_NAME \
  --do_train \
  --rew \
  ...
  --block_row_width 12 \
  --output_dir /data/ZLKong/bert_vector/tinybert-prune/MRPC-shaoyi \
  --overwrite_output_dir \
  --logging_steps 20000 \
  --logging_dir  /data/ZLKong/bert_vector/tinybert-prune/MRPC-shaoyi \
  --save_steps 40000
