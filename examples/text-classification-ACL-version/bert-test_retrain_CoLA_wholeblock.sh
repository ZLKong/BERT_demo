...
export IN_DIR=/data/ZLKong/bert_whole_block/bert-prune/CoLA
...
CUDA_VISIBLE_DEVICES=2 python run_glue.py \
  ...
  --block_row_width 256 \
  --output_dir /data/ZLKong/bert_whole_block/bert-retrain/CoLA-30-noemb \
  --overwrite_output_dir \
  --logging_steps 20000 \
  --logging_dir /data/ZLKong/bert_whole_block/bert-retrain/CoLA-30-noemb \
  --save_steps 40000
