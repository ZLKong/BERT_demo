...
export INT_DIR=/data/ZLKong/irregular/results/bert-finetune/SST-2
...
#export INT_DIR=/data/ZLKong/irregular/results/bert-retrain/SST-2_50
export OUT_DIR=/data/ZLKong/bert/finetune/failure

CUDA_VISIBLE_DEVICES=6 python geng_dac_differential-test.py \
