...
CUDA_VISIBLE_DEVICES=1 python run_glue.py \
  --model_name_or_path /data/ZLKong/irregular/results/bert-finetune/SST-2 \
  --task_name $TASK_NAME \
  --do_train \
  --rew \
  ...
  --block_row_width 256 \
  --output_dir /data/ZLKong/bert_whole_block/bert-prune/SST-2 \
  --overwrite_output_dir \
  --logging_steps 20000 \
  --logging_dir  /data/ZLKong/bert_whole_block/bert-prune/SST-2 \
  --save_steps 40000
