        ...
        if self.args.rew:
            ...
            for i in range(len(layers)):
                ...
                if (self.args.sparsity_type == "irregular"):
                    ...
                    #    print('after block_row_division int',block_row_division)
                    #else:
                    ...
                    #if args.same_size:
                        #block_row_width = int(conv.shape[1]/block_row_width)
                    ...
                    print('after block_number int',block_number)
                    if block_number==0:
                        convfrag = torch.chunk(conv, 1, dim=0)
                    else:
                        convfrag = torch.chunk(conv, block_number, dim=0)
                    print('convfrag',len(convfrag))
                        ...
                        for j in range(len(layers)):
                            if (self.args.sparsity_type == "irregular"):
                                ...
                                if block_number==0:
                                    ...
                                    convfrag = torch.chunk(conv, block_number, dim=0)   # if cross_f=8, convfrag[j].shape=[8,27]. -libn
