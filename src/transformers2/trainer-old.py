            ...
            for i in range(len(layers)):
                ...
                if (self.args.sparsity_type == "irregular"):
                    ...
                    for j in range(len(convfrag)):
                        print('convfrag[j].shape',convfrag[j].shape)
                        if mat is None:
                            mat = convfrag[j]
                        else:
                    ...
                    if block_row_division != 0:
                        ...
                        if conv.shape[0]%block_row_width != 0 :
                            ...
                            # raise SyntaxError("block_size error")
                    print('block_row_width',block_row_width)
                    if block_row_width==0:  #for [2,768]
                        convfrag = torch.chunk(conv, 1, dim=0)
                    else:
                            ...
                            if (self.args.sparsity_type == "irregular"):
                                ...
                                for k in range(len(convfrag)):
                                    if mat is None:
                                        ...
                                        mat = torch.cat((mat, convfrag[k]), 1)  # mat.shape=[64*num_blocks, 4]. -libn
